...
type family ValidElementsFor (attribute :: AttributeType) :: [TagType] where
  ...
  ValidElementsFor 'Hide                      = [ Tags.Form, Tags.Header, Tags.Image, Tags.Item, Tags.List, Tags.Section, Tags.SectionList, Tags.SectionTitle, Tags.Text, Tags.TextField, Tags.View ]
  ValidElementsFor 'Html                      = '[ Tags.WebView ]
  ValidElementsFor 'Id                        = [ Tags.Body, Tags.Form, Tags.Header, Tags.Image, Tags.Item, Tags.List, Tags.Screen, Tags.Section, Tags.SectionList, Tags.SectionTitle, Tags.Text, Tags.TextField, Tags.View, Tags.WebView ]
  ...
  ValidElementsFor 'Name                      = '[ Tags.TextField ]
  ...
  ValidElementsFor 'Style                     = [ Tags.Body, Tags.Form, Tags.Header, Tags.Image, Tags.Item, Tags.List, Tags.SectionList, Tags.SectionTitle, Tags.Text, Tags.TextField, Tags.View ]
