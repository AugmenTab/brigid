...
type family ValidElementsFor (attribute :: AttributeType) :: [TagType] where
  ...
  ValidElementsFor 'Hide                      = [ Tags.Form, Tags.Header, Tags.Image, Tags.Item, Tags.List, Tags.Option, Tags.PickerField, Tags.Section, Tags.SectionList, Tags.SectionTitle, Tags.SelectMultiple, Tags.SelectSingle, Tags.Switch, Tags.Text, Tags.TextField, Tags.View ]
  ValidElementsFor 'Href                      = '[ Tags.NavRoute ]
  ValidElementsFor 'Html                      = '[ Tags.WebView ]
  ValidElementsFor 'Id                        = [ Tags.Body, Tags.Form, Tags.Header, Tags.Image, Tags.Item, Tags.List, Tags.Navigator, Tags.NavigatorStack, Tags.NavigatorTab, Tags.NavRoute, Tags.Option, Tags.PickerField, Tags.Screen, Tags.Section, Tags.SectionList, Tags.SectionTitle, Tags.SelectMultiple, Tags.SelectSingle, Tags.Switch, Tags.Text, Tags.TextField, Tags.View, Tags.WebView ]
  ...
  ValidElementsFor 'Modal                     = [ Tags.Navigator, Tags.NavigatorStack, Tags.NavRoute ]
  ...
  ValidElementsFor 'Name                      = [ Tags.PickerField, Tags.SelectMultiple, Tags.SelectSingle, Tags.Switch, Tags.TextField ]
  ...
  ValidElementsFor 'Selected                  = [ Tags.Modifier, Tags.NavRoute ]
  ...
  ValidElementsFor 'Style                     = [ Tags.Body, Tags.Form, Tags.Header, Tags.Image, Tags.Item, Tags.List, Tags.Option, Tags.SectionList, Tags.SectionTitle, Tags.SelectMultiple, Tags.SelectSingle, Tags.Switch, Tags.Text, Tags.TextField, Tags.View ]
  ValidElementsFor 'Type                      = [ Tags.Navigator, Tags.NavigatorStack, Tags.NavigatorTab ]
  ValidElementsFor 'Url                       = '[ Tags.WebView ]
  ValidElementsFor 'Value                     = [ Tags.Option, Tags.PickerField, Tags.PickerItem, Tags.Switch, Tags.TextField ]
