...
type family ValidElementsFor (attribute :: AttributeType) :: [TagType] where
  ...
  ValidElementsFor 'Id                        = [ Tags.Body, Tags.Header, Tags.Image, Tags.Item, Tags.List, Tags.Screen, Tags.Section, Tags.SectionList, Tags.SectionTitle, Tags.Text, Tags.View, Tags.WebView ]
