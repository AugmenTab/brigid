...
type family ValidElementsFor (attribute :: AttributeType) :: [TagType] where
  ...
  ValidElementsFor 'Hide                      = [ Tags.Form, Tags.Header, Tags.Image, Tags.Item, Tags.List, Tags.Option, Tags.Section, Tags.SectionList, Tags.SectionTitle, Tags.SelectMultiple, Tags.SelectSingle, Tags.Text, Tags.TextField, Tags.View ]
  ValidElementsFor 'Html                      = '[ Tags.WebView ]
  ValidElementsFor 'Id                        = [ Tags.Body, Tags.Form, Tags.Header, Tags.Image, Tags.Item, Tags.List, Tags.Navigator, Tags.NavigatorStack, Tags.NavigatorTab, Tags.Option, Tags.Screen, Tags.Section, Tags.SectionList, Tags.SectionTitle, Tags.SelectMultiple, Tags.SelectSingle, Tags.Text, Tags.TextField, Tags.View, Tags.WebView ]
  ...
  ValidElementsFor 'Name                      = [ Tags.SelectMultiple, Tags.SelectSingle, Tags.TextField ]
  ...
  ValidElementsFor 'Value                     = [ Tags.Option, Tags.TextField ]
