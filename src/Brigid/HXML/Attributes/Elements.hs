...
type family ValidElementsFor (attribute :: AttributeType) :: [TagType] where
  ...
  ValidElementsFor 'Hide                  = [ Tags.Header, Tags.Image, Tags.Text, Tags.View ]
  ValidElementsFor 'Id                    = [ Tags.Body, Tags.Header, Tags.Image, Tags.Screen, Tags.Text, Tags.View ]
  ...
  ValidElementsFor 'Style                 = [ Tags.Body, Tags.Header, Tags.Image, Tags.Text, Tags.View ]
