...
type family ValidElementsFor (attribute :: AttributeType) :: [TagType] where
  ...
  ValidElementsFor 'Hide                  = '[ Tags.Header, Tags.View ]
  ValidElementsFor 'Id                    = '[ Tags.Body, Tags.Header, Tags.Screen, Tags.View ]
  ...
  ValidElementsFor 'Style                 = '[ Tags.Body, Tags.Header, Tags.View ]
