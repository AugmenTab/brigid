...
type family ValidElementsFor (attribute :: AttributeType) :: [TagType] where
  ...
  ValidElementsFor 'Download                 = [ Tags.Anchor, Tags.Area ]
  ...
  ValidElementsFor 'Headers                  = '[ Tags.TableDataCell, Tags.TableHeader ]
  ...
  ValidElementsFor 'ImageSizes               = '[ Tags.Link ]
  ValidElementsFor 'ImageSrcset              = '[ Tags.Link ]
  ...
  ValidElementsFor 'Ping                     = [ Tags.Anchor, Tags.Area ]
  ...
  ValidElementsFor 'ShadowRootMode           = '[ Tags.ContentTemplate ]
  ValidElementsFor 'ShadowRootDelegatesFocus = '[ Tags.ContentTemplate ]
  ValidElementsFor 'ShadowRootClonable       = '[ Tags.ContentTemplate ]
  ValidElementsFor 'Shape                    = '[ Tags.Area ]
  ValidElementsFor 'Size                     = Add Tags.Select TagGroups.FreeTextInputTags
  ValidElementsFor 'Sizes                    = [ Tags.Image, Tags.Link, Tags.Source ]
