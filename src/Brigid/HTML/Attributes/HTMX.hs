...
hxSync :: ( KnownNat branchIndex
          , branchIndex ~ FirstIndexOf selector Types.HxTargetTypes
          )
       => selector -> Maybe Types.SyncStrategy -> Attribute tag
hxSync selector = Attr_HxSync . Types.mkSync selector
