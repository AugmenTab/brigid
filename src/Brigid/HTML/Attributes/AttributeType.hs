...
type family AttributeErrorMessage (attr :: AttributeType) :: ErrorMessage where
  ...
  AttributeErrorMessage ShadowRootMode           = 'Text "ShadowRootMode (shadowrootmode)"
  AttributeErrorMessage ShadowRootDelegatesFocus = 'Text "ShadowRootDelegatesFocus (shadowrootmodedelegatesfocus)"
  AttributeErrorMessage ShadowRootClonable       = 'Text "ShadowRootClonable (shadowrootclonable)"
