...
{-# INLINE popupMenuToBytesBuilder #-}
...
{-# INLINE popupListboxToBytesBuilder #-}
...
{-# INLINE popupTreeToBytesBuilder #-}
...
{-# INLINE popupGridToBytesBuilder #-}
...
{-# INLINE popupDialogToBytesBuilder #-}
